...
function getSeedData() {
  ...
  return {
    ...
    team: [
      { id: 1, name: 'Himanshu Pathak', role: 'Founder & AI Automation Engineer', bio: 'Founder of SmartFiQ. Specializes in Agentic AI architecture, app development, LLM orchestration, and business automation.', image: 'https://media.licdn.com/dms/image/v2/D5603AQF3kYT7udRwtQ/profile-displayphoto-crop_800_800/B56Z335B8WIQAM-/0/1777980421180?e=1787788800&v=beta&t=fOfgwNLU04_HlzvnnW0mbeC1oncH36wdCeq2AXj2pcw', linkedin: 'https://linkedin.com/in/himanshupathak8830', skills: ['AI Agents', 'LLM Orchestration', 'WhatsApp API', 'Power BI', 'Full-Stack Development'], revenue: '₹5.2L', leads: 42, attendance: '100%', kpi: '5.0/5' },
      { id: 2, name: 'Aman', role: 'Lead Automation Engineer & CRM Specialist', bio: 'Expert in sales pipeline automation, n8n workflow integration, custom CRM management, and client lead onboarding.', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=400', linkedin: 'https://linkedin.com/company/smartfiq', skills: ['n8n Workflow', 'Lead CRM', 'API Integrations', 'Client Onboarding'], revenue: '₹3.8L', leads: 38, attendance: '99%', kpi: '4.9/5' },
      { id: 3, name: 'Amit', role: 'Data Analyst & Power BI Developer', bio: 'Specializes in automated DAX data modeling, executive business dashboards, financial reporting, and web scraping.', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400', linkedin: 'https://linkedin.com/company/smartfiq', skills: ['Power BI', 'Data Modeling', 'DAX', 'Python Web Scraping', 'SQL'], revenue: '₹3.1L', leads: 29, attendance: '98%', kpi: '4.8/5' }
    ],
    cms: {
      brandName: 'Smartfiq',
