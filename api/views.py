...
def _link_visitor(session_id, lead_id="", email=""):
    ...
    try:
        ...
        print("Link visitor exception:", e)
...
def leads_api(request, lead_id=None):
    ...
    try:
        ...
        return JsonResponse({"success": True, "message": "Lead received"}, status=200)
...
def stats_api(request):
    try:
        ...
        return JsonResponse({"leadsCount": 0, "subscribersCount": 0, "dailyVisitors": 0, "visitorsCount": 0, "systemHealth": "Operational"})
